...
| -- | -- | -- | -- |
| `wiki/current-scene/` | Current turn snapshot | Overwrite | Keep only the latest scene state. Never accumulate prior scenes here. |
...
3. Stale-state cleanup before merge
