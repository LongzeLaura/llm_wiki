import type { BuildRpgNarrationPromptInput, RpgNarrationPrompt } from "./narration-interaction"
import { cleanRpgReferences, type RpgActionIntent, type RpgRiskLevel, type RpgTurnResult } from "../../rpg-runtime/turn-model"

export interface RpgNarrationAdapter {
  generateTurn(prompt: RpgNarrationPrompt, promptInput?: BuildRpgNarrationPromptInput): Promise<RpgTurnResult>
}
