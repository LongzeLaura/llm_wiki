...
export function buildChunkAnalysisSystemPrompt(
  ...
  return [
    ...
    "- Routing decisions under the ordinary Source Ingest target policy",
    ...
    "Quest-like material is REVIEW-only in ordinary Source Ingest until a dedicated mode owns it.",
