...
describe("project-mode", () => {
  ...
  it("provides llmWikiRPG bootstrap files and directories", () => {
    ...
    expect(bootstrap.schema).toContain("wiki/outlines/main.md")
    expect(bootstrap.schema).toContain("wiki/outlines/progress.md")
    expect(bootstrap.schema).toContain("wiki/relationships/runtime/")
    expect(bootstrap.schema).toContain("wiki/plot-arcs/runtime/")
    expect(bootstrap.schema).toContain("manual_or_review_only")
    expect(bootstrap.schema).toContain("`player_abilities`")
    expect(bootstrap.schema).toContain("Do not create arbitrary player files")
    expect(bootstrap.schema).toContain("| `wiki/quests/` | Objective tracking | manual/runtime merge |")
    expect(bootstrap.schema).toContain("completion state")
    ...
    expect(bootstrap.extraDirs).toContain("wiki/outlines")
    expect(bootstrap.extraDirs).toContain("wiki/relationships/runtime")
    expect(bootstrap.extraDirs).toContain("wiki/plot-arcs/runtime")
    expect(bootstrap.extraDirs).toContain("wiki/quests")
    expect(bootstrap.extraDirs).toContain("wiki/memory")
    expect(bootstrap.index).toContain("## Outlines")
