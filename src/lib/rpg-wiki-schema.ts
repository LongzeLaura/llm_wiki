...
export const RPG_WIKI_SCHEMA = [
  ...
  defineSchema("characters", {
    ...
    fields: [
      ...
      { name: "relationshipDynamics", description: "## Relationship Dynamics. Durable attachment, distrust, rivalry, dependence, manipulation, protection, hierarchy, or testing patterns toward recurring characters or groups." },
  ...
  defineSchema("locations", {
    extractionGoal: "Capture important or repeatedly referenced places, scenes, spatial relationships, access conditions, and location state. After character, event, and relationship extraction, do a secondary scan for plot-relevant locations that were only mentioned indirectly.",
    fields: [
    ...
    updateStrategy: "merge",
    recommendedGranularity: "One page per important or repeatedly referenced place; split large locations into sublocation pages when useful. If a core location is identifiable but source coverage is thin, a short stub with an explicit limited-source or to-be-expanded note is acceptable.",
  }),
  defineSchema("factions", {
    extractionGoal: "Maintain organizations, groups, agendas, members, resources, influence, and faction relationships. After character, event, and relationship extraction, do a secondary scan for repeatedly mentioned or plot-relevant families, institutions, and factions.",
    fields: [
    ...
    updateStrategy: "merge",
    recommendedGranularity: "One page per major organization, group, family, institution, army, cult, or faction. If a core faction is identifiable but source coverage is thin, a short stub with an explicit limited-source or to-be-expanded note is acceptable.",
  }),
  defineSchema("items", {
